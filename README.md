...
Перед запуском должен быть установлен Google Chrome.
...
По умолчанию тесты запускаются в headless-режиме, то есть без видимого окна браузера. Selenium Manager автоматически подбирает драйвер для установленного Chrome.
